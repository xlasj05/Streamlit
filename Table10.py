...
# File path
file_path = 'C:\\Python\\idealista_A9.csv'
...
columns_to_display = ['price', 'size', 'rooms', 'bathrooms', 'Restaurants', 'Shops', 'av_rent', 'airport_distance', 'municipality', 'Link', 'propertyCode']
...
# Apply formatting only to the displayed data
